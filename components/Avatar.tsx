...
function Avatar({
  ...
  const [url, setUrl] = useState(user?.avatarUrl || encodeURI(`https://avatars.dicebear.com/api/identicon/${user.username}.svg?options[background]=#004346&options[colors]=["blueGrey"]&options[colorLevel]=50`));
