...
const Writers: NextPage = (): React.ReactElement => {
  ...
  return (
    <Container className="overflow-x-hidden relative">
      ...
      <div className="min-h-screen flex flex-col justify-between container mx-auto px-10">
        ...
        <section className="flex items-center pb-20 md:pb-48 lg:px-10">
      ...
      <section className="bg-primary text-snow lg:w-11/12 mx-auto z-10 grid grid-rows-3 md:grid-rows-1 md:grid-cols-3 text-center p-10">
        <div className="col-span-1 p-5">
          <h2 className="font-bold text-3xl pb-5 font-serif">Quality Not Quantity</h2>
          <p className="text-lg xl:text-xl">Get rewarded based on the value you provide, not on how many clicks you get. The end of clickbait has arrived.</p>
        </div>

        <div className="col-span-1 p-5">
          <h2 className="font-bold text-3xl pb-5 font-serif">We Got Your Back</h2>
          <p className="text-lg xl:text-xl">We give you the tools you need to thrive. Forget about setting up a website or newsletters. Focus on your writing.</p>
        </div>

        <div className="col-span-1 p-5">
          <h2 className="font-bold text-3xl pb-5 font-serif">Build Your Audience</h2>
          <p className="text-lg xl:text-xl">Reach new readers who are hungry for quality content and eager to reward it.</p>
        </div>
      </section>
